...
topPath = '/volumes/data/phd/data/clef2016Tuned_local_topFiles/'
...
for bt in xrange(0, 101, 5):
    for bb in xrange(0, 101, 5):
        for k in xrange(24, 25, 2): # best K1 value obtained after tuning with uniform b for CLEF 2016 is 2.4
